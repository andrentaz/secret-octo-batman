...
public class SetupDialogFragment extends DialogFragment {
    ...
    private SetupDialogListener mListener;

    // Override the Fragment.onAttach() method to instantiate the SetupDialogListener
    @Override
    public void onAttach(Activity activity) {
        super.onAttach(activity);
        // Verify that the host activity implements the callback interface
        try {
            // Instantiate the SetupDialogListener so we can send events to the host
            mListener = (SetupDialogListener) activity;
        ...
        builder.setView(inflater.inflate(R.layout.dialog_add_people, null))
                ...
                .setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mListener.onSetupDialogPositiveClick(SetupDialogFragment.this);
                    }
                })
                .setNegativeButton(R.string.dialog_cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mListener.onSetupDialogNegativeClick(SetupDialogFragment.this);
                    }
                });
