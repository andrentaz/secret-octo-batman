...
public class PeopleDialogFragment extends DialogFragment {
    ...
    // Override the Fragment.onAttach() method to instantiate the PeopleDialogListener
    @Override
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            throw new ClassCastException(activity.toString()
                    + " must implement PeopleDialogListener");
        }
    }
        ...
        builder.setView(inflater.inflate(R.layout.dialog_add_people, null))
                ...
                .setPositiveButton(R.string.dialog_add_people, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mListener.onPeopleDialogPositiveClick(PeopleDialogFragment.this);
                    }
                })
                .setNegativeButton(R.string.dialog_cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mListener.onPeopleDialogNegativeClick(PeopleDialogFragment.this);
                    }
                });
